...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.midasbuy.com/oversea_web/static/css/homepage.16b7cacd.css?max_age=864000" />
...
<body>
    <input type="hidden" id="xMidasToken" value="287817131b146ffe95c51ffb41feb028d72224d5bfc8c87507d60c1d4b5096fecf72a872ee746777dc0595f032f7a872">
    ...
    <script>
        window.fbSocial = {
            ...
            "image": "https://cdn.midasbuy.com/images/%E8%B5%9B%E5%AD%A31_1920_300_enffabb89b.jpg"
        }
        window.country = "ot"
    </script>
    <div class="wrap special-area ">
        ...
        <div class="banner-wrap" id="bannner-swiper-container">
            <ul>

                <li class="active  slide" style="background: url('https://cdn.midasbuy.com/images/s24_2880x600cc2b763b.jpg') no-repeat center;background-size: cover;"></li>

            </ul>
            <div class="con">
                <div class="x-main">
                    <img class="logo" src="https://cdn.midasbuy.com/images/apps/pubgm/PUBGM_LOGO.png" alt="img" />
                    <div class="box">
                        <p class="name">PUBG Mobile</p>
                        <a>Official Website</a>
                    </div>
                    <a class="down-game">
                        <img src="https://cdn.midasbuy.com/images/gamedownload6d44292c.png" alt="img" />
                        <p>Download Game</p>
                    </a>
                </div>
            </div>
        ...
        <div id="app" class="content">
            <div class="x-main">
                <div class="nav-item-box nav-3-item-box">
                    <ul class="item-box">


                        <li class="item item-1" cr="topup">
                            <a href="purchase" class="go-currency-btn">
                                <p class="name">Exchange BP</p>
                                <img src="https://cdn.midasbuy.com/images/item-179be42ef.png" alt="img" />
                                <p class="label" v-show="marketLabel.currency" v-cloak>{{ marketLabel.currency }}</p>
                            </a>
                        </li>

                        
                        <li class="item item-3" cr="mail">
                            <a href="items" class="go-items-btn">
                                <p class="name">Exchange BP</p>
                                <img src="https://i.ibb.co/FwCwLRf/1629021482753.png" alt="img" />
                                <p class="label" v-show="marketLabel.item" v-cloak>{{ marketLabel.item }}</p>
                            </a>
                        </li>
            ...
            <!-- 推荐物品开关 -->
            <div class="x-main" v-if="showRecommend">
                <div class="section shop-list-mod">
                    <h3> </h3>
                    <product-list :props-products-list="productsList" :lanres="lanRes"></product-list>
                </div>
            </div>
            <div class="c-main">
                <div class="hot-events g-clr">
                    <h3> HOT EVENTS </h3>

                    <div class="box">
                        <div class="banner">
                            <div id="tab-swiper" class="swiper-container" style="height: auto;overflow: visible;">
                                <div class="swiper-wrapper" id="swiper-wrapper">

                                    <div class="swiper-slide" cr="banner" style="cursor:pointer;background: url(https://cdn.midasbuy.com/images/vipbanner2702385a4fe.jpg) no-repeat center;background-size: cover;"></div>

                                    <div class="swiper-slide" cr="banner" style="cursor:pointer;background: url(https://cdn.midasbuy.com/images/1005x270bd853861.jpg) no-repeat center;background-size: cover;"></div>

                                    <div class="swiper-slide" cr="banner" style="cursor:pointer;background: url(https://cdn.midasbuy.com/images/vipbanner2702385a4fe.jpg) no-repeat center;background-size: cover;"></div>

                                    <div class="swiper-slide" cr="banner" style="cursor:pointer;background: url(https://cdn.midasbuy.com/images/1005_2707408ce7c.png) no-repeat center;background-size: cover;"></div>
                        ...
                        <div class="mess">
                            <div class="block">
                                ...
                                <p class="title">
                                    Top Up by Cards and Get Permanent Items！
                                </p>
                                <p class="desc" title="">
            ...
            <div class="x-main" v-if="fbSocial.show" v-cloak>
                <div class="section keep-in-touch">
                    <h3> {{ lanRes.contactFacebook }} </h3>
                    <div class="box">
                        <div class="pic-box" :style="getFbPictureStyle"></div>
                        <div class="mess">
                            <div class="block">
                                <p class="title"> {{ lanRes.contactTitle }} </p>
                                <p class="desc"> {{ lanRes.contactDesc }} </p>
                            </div>
                            <div class="join-btn"><a target="_blank" :href="getFbGroupHref">
                                    <p> {{ lanRes.contactBtn }} </p>
                                </a></div>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            var eventsAdData = [{
                "title": "Top Up by Cards and Get Permanent Items！",
                "url": "https://cdn.midasbuy.com/images/1005_270219ccea4.png",
                "start": "2021-05-27 20:47:50+0800",
                "end": "2021-06-10 00:00:00+0800"
            }, {
                "title": "Get Free Bunny Girl Set!",
                "url": "https://cdn.midasbuy.com/images/tuijian9e6137f6.jpg",
                "start": "2021-04-16 18:09:05+0800",
                "end": "2021-08-14 00:00:00+0800"
            }, {
                "end": "2021-11-30 23:59:59+0800",
                "id": "01474013943969279005",
                "start": "2019-08-05 00:00:00+0800",
                "title": "VIP Lucky Draw",
                "url": "https://cdn.midasbuy.com/images/vipbanner2702385a4fe.jpg"
            }, {
                "end": "2021-06-07 23:59:59+0800",
                "id": "01474013943969279125",
                "start": "2019-08-05 00:00:00+0800",
                "title": "INVITE FRIEND TO PURCHASE ,BOTH OF YOU GET EXCLUSIVE REWARD！",
                "url": "https://cdn.midasbuy.com/images/23123c479956a.jpg"
            }];
            var bannerData = [{
                "end": "2021-11-30 23:59:59+0800",
                "href": "#",
                "id": "01474013943969279000",
                "start": "2019-08-05 00:00:00+0800",
                "title": "World ",
                "url": "https://cdn.midasbuy.com/images/zhuanqu92850937.jpg"
            }];
        </script>
        <script>
            window.productsList = [{
                "name": "Collect Reward (Season M2)",
                "productid": "Season Mount 2",
                "product_detail": "",
                "price": "999",
                "num": "",
                "currency_type": "USD",
                ...
                "rank_num": "2",
                "is_hot_product": "0",
                "image_url": "https://i.ibb.co/YDfhYR5/Pics-Art-08-15-06-17-19.jpg",
                ...
                "name": "Royale Pass Project Reward (Mount 2)",
                "productid": "Reward Royale Mount 2",
                "product_detail": "",
                "price": "2499",
                "num": "",
                "currency_type": "USD",
                ...
                "rank_num": "7",
                "is_hot_product": "0",
                "image_url": "https://i.ibb.co/wpPP3GF/1628826514706.png",
                "description": "Please collect it from in-game mail.",
                "reserve_time": "",
                "sub_product": [{
                    ...
                    "sub_productid": "Royale Pass Project Reward (Mount 2)",
                    "sub_product_count": "1",
                    "description": ""
                }],
                "limit": true,
            ...
            window.MP_INFO = {};
            window.seasonCardPid = "Royale Pass Project Reward (Mount 2)";
            window.showRecommend = false;
        </script>
        <script src="https://cdn.midasbuy.com/oversea_web/static/js/homepage.0aad0388.js"></script>
    </div>
    <script>
        //监听滚动停止
        var scrollT1 = 0;
